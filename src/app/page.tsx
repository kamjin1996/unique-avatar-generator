...
export default function Home() {
    return (
        <div>
            <main className="flex min-h-screen flex-col items-center justify-between p-6 dark:bg-gray-900">
                ...
                <div>
                    <div
                        className='text-4xl bg-gradient-to-r from-blue-500 to-purple-500 text-transparent bg-clip-text md:text-5xl font-bold mb-2 text-center'>Generate
